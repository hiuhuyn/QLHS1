...
public class FormBaoCaoTongKetHocKi extends JPanel {
	private JTable jTable;

	/**
	 * Create the panel.
	 */
	public FormBaoCaoTongKetHocKi() {
		setLayout(null);
		...
		JLabel lblBm = new JLabel("BM5.1");
		lblBm.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblBm.setBounds(10, 11, 46, 14);
		panel.add(lblBm);
		
		JLabel lblNewLabel_1 = new JLabel("Báo cáo tổng kết học môn");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1.setBounds(369, 6, 190, 24);
		...
		JLabel lblNewLabel_2_1 = new JLabel("Học kì");
		...
		btn_tim.setBounds(783, 17, 109, 36);
		panel_1.add(btn_tim);
		...
		comboBox_HocKi.setBounds(422, 17, 90, 36);
		...
		comboBox.setBounds(67, 15, 134, 38);
